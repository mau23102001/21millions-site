...
const WHATSAPP_LINK = "https://wa.me/51999999999?text=Hola%20quiero%20agendar%20un%20diagnostico";

export default function Landing21Millions() {
  const [mobileOpen, setMobileOpen] = useState(false);

  // 👇 Tabs controlado para evitar que se “congele” o se resetee al navegar por anclas
      ...
      <div className="min-h-screen bg-white text-neutral-900">
        ...
        <header className="sticky top-0 z-40 bg-white/80 backdrop-blur border-b border-neutral-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
            ...
            {/* Derecha: CTA */}
            <div className="flex items-center gap-3">
              <a aria-label="Agendar diagnóstico por WhatsApp" href={WHATSAPP_LINK} target="_blank" rel="noopener" className="hidden sm:inline-block">
                <Button className="bg-brand hover:bg-brand-dark text-black">Agenda diagnóstico</Button>
              </a>
          ...
          {mobileOpen && (
            <nav id="mobile-menu" className="md:hidden border-t">
              <div className="px-4 py-3 flex flex-col gap-3 text-sm">
                <a href="#servicios" className="hover:text-neutral-700" onClick={() => setMobileOpen(false)}>Servicios</a>
                <a href="#proceso" className="hover:text-neutral-700" onClick={() => setMobileOpen(false)}>Cómo trabajamos</a>
                <a href="#niif" className="hover:text-neutral-700" onClick={() => setMobileOpen(false)}>NIIF &amp; SUNAT</a>
                <a href="#faq" className="hover:text-neutral-700" onClick={() => setMobileOpen(false)}>FAQ</a>
                <a href="#contacto" className="hover:text-neutral-700" onClick={() => setMobileOpen(false)}>Contacto</a>
              </div>
            </nav>
          )}
        </header>
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-28 relative z-0">
            <div className="grid lg:grid-cols-12 gap-10 items-center">
              <div className="lg:col-span-7">
                ...
                <div className="mt-8 flex flex-wrap gap-3">
                  <a href="#contacto">
                    <Button size="lg" className="bg-brand hover:bg-brand-dark text-black">Agenda tu diagnóstico gratuito</Button>
                  </a>
                ...
                <div className="mt-6 flex flex-wrap items-center gap-4 text-sm text-neutral-600">
                  <div className="flex items-center gap-2"><Shield className="h-4 w-4" /> Enfoque no-custodia / sin trading por cuenta del cliente</div>
                  <div className="flex items-center gap-2"><FileCheck2 className="h-4 w-4" /> Metodología documentada y auditable</div>
                </div>
              </div>

              <div className="lg:col-span-5">
                <Card className="shadow-xl rounded-2xl">
                  <CardHeader><CardTitle className="text-xl">Caso rápido: Asignación 5% de caja</CardTitle></CardHeader>
                  <CardContent className="space-y-3 text-sm">
                    <div className="flex items-center justify-between"><span>Caja disponible</span><strong>S/ 4,000,000</strong></div>
                    <div className="flex items-center justify-between"><span>Asignación inicial</span><strong>5% (S/ 200,000)</strong></div>
                    <div className="flex items-center justify-between"><span>Estrategia</span><span>DCAs trimestrales + rebalance</span></div>
                    <div className="flex items-center justify-between"><span>Horizonte</span><span>36–60 meses</span></div>
                    <div className="flex items-center gap-2 text-neutral-600"><CheckCircle className="h-4 w-4" /> Política de inversión aprobada por comité de tesorería</div>
                  </CardContent>
                </Card>
              </div>
            </div>
        ...
        <section className="border-y border-neutral-200">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 grid grid-cols-2 md:grid-cols-4 gap-6 items-center">
            {["Política de tesorería", "Análisis de flujo de caja", "Modelo contable NIIF", "Compliance SUNAT"].map((t, i) => (
      ...
      <Tabs defaultValue="empresas" className="w-full">
            ...
            <div className="grid lg:grid-cols-12 gap-10">
              <div className="lg:col-span-6">
                ...
                <p className="mt-3 text-neutral-700">
                  Tratamos a Bitcoin como activo intangible (NIIF), con notas de revelación y políticas de depreciación/impairment cuando corresponda.
                  Documentamos el criterio y el procedimiento contable para auditorías.
                </p>
              ...
              <div className="lg:col-span-6">
                <Card className="rounded-2xl">
                  ...
                  <CardContent className="text-sm space-y-2">
                    <div className="flex items-center gap-2"><Scale className="h-4 w-4" /> Política de Tesorería BTC</div>
                    <div className="flex items-center gap-2"><FileCheck2 className="h-4 w-4" /> Minuta para comité de tesorería</div>
                    <div className="flex items-center gap-2"><Banknote className="h-4 w-4" /> Modelo de asientos contables (ejemplo)</div>
                    <div className="flex items-center gap-2"><Globe className="h-4 w-4" /> Procedimiento operativo estándar (POE)</div>
                  </CardContent>
                </Card>
              </div>
            </div>
            ...
            <div className="mt-8">
              <Accordion>
                <AccordionItem value="a1">
                  ...
                  <AccordionContent>No. Somos consultores. Diseñamos la estrategia y te guiamos para que compres y custodies tú (o tu empresa) con buenas prácticas y controles internos.</AccordionContent>
                </AccordionItem>
                <AccordionItem value="a2">
                  <AccordionTrigger>¿Cómo se refleja en la contabilidad (NIIF)?</AccordionTrigger>
                  <AccordionContent>En general, como activo intangible, con revelaciones y políticas de valuación/impairment documentadas. Entregamos formatos y anexos de soporte para auditoría.</AccordionContent>
                </AccordionItem>
                <AccordionItem value="a3">
                  <AccordionTrigger>¿Qué porcentaje recomiendan asignar?</AccordionTrigger>
                  <AccordionContent>Depende de tu caja, tu tolerancia al riesgo y tu horizonte. Empezamos con diagnósticos conservadores (1–5%) y revisamos trimestralmente.</AccordionContent>
                </AccordionItem>
                ...
                <Card className="bg-white text-neutral-900 rounded-2xl">
                  ...
                  <CardContent>
                    <form method="POST" action="https://formspree.io/f/your-id" className="space-y-4">
                      ...
                      <Button type="submit" className="w-full bg-brand hover:bg-brand-dark text-black">Enviar</Button>
                    </form>
        ...
        <footer className="py-10 border-t border-neutral-200 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col md:flex-row items-center justify-between gap-4">
            <div className="text-sm text-neutral-600">© {new Date().getFullYear()} 21 Millions Enterprises S.A.C. — Todos los derechos reservados.</div>
